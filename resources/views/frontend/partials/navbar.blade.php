  <nav class="navbar navbar-default" style="padding-bottom:5px;">
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="{{ route('mastulnet') }}">
                                <img src="{{ asset('images/Mastul_logo_resize.png') }}" alt="logo">
                            </a>
                        </div>
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <div class="navbar-right">
                                <ul class="nav navbar-nav ">
                                    ...
                                    <li class="dropdown text-uppercase">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Child <span class="caret"></span></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="text-uppercase"><a href="{{ route('members') }}">Our Sponsor</a></li>
                                    <li class="text-uppercase"><a href="resource.html">Event</a></li>
                                    <li class="text-uppercase"><a href="{{route('contact')}}">Contact</a></li>
                                  
                                </ul>
                                <button class="lern bg_trans border_circle bold full_width_480 video_icon" data-toggle="modal" data-target="#video"><i class="icofont-play-alt-1"></i> Our Contribution?</button>
                                <!--Header video here-->
                                <div class="modal fade video_modal" id="video" tabindex="-1" role="dialog">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                <h4 class="font_s_20 bold">Donate and Save the Orphane people</h4>
                                ...
                                <form action="{{ route('userlogout') }}" method="post">
                                  @csrf
                                <button type="submit" class="btn_cus join_us clr_white bg_red border_none border_circle bold text-uppercase full_width_480 ">{{Auth::user()->name}}</button>
                                </form>
                            @endauth
                            @auth("admin")
